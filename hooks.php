<?php
/**
 * ksf_FA_EmailManager Module Hooks for FrontAccounting
 */

define('SS_ksf_FA_EmailManager', 100 << 8);
...
class hooks_ksf_FA_EmailManager extends hooks {
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_EmailManager] = _("");
        $security_areas['SA_ksf_FA_EmailManagerVIEW'] = array(SS_ksf_FA_EmailManager | 1, _("View "));
        $security_areas['SA_ksf_FA_EmailManagerMANAGE'] = array(SS_ksf_FA_EmailManager | 2, _("Manage "));
